...
_Generated by `tools/audit_migration.mjs --update` on 2026-05-23T23:02:54Z._

**Coverage:** 19/165 (16 HOSTED via legacy-mount bridge + 3 DONE via native facets).
Remaining: 60 FACET-only / 86 DOC-only / 0 MISSING.
