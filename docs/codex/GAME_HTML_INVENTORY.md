...
_Generated by `tools/audit_migration.mjs --update` on 2026-05-24T02:13:06Z._

**Coverage:** 23/165 — 2 SEMANTIC_PROVEN + 16 BIND_ONLY + 5 native (4 DONE, 0 NATIVE_BUILT, 1 NATIVE_VERIFIED).
...
| `mountStaminaTick` | yes | — | yes | yes | NATIVE_VERIFIED | drain 100 -> 90 over 0.4s with W+Shift held @ STAMINA_DRAIN 25/s (test_legacy_bridge.mjs phase 3) |
