...
_Generated by `tools/audit_migration.mjs --update` on 2026-05-24T04:15:09Z._

**Migration coverage:** 24/165 — 1 SEMANTIC_PROVEN + 12 BIND_ONLY + 11 native (10 DONE, 0 NATIVE_BUILT, 1 NATIVE_VERIFIED).
...
| `mountCamShakeTick` | yes | — | yes | yes | NATIVE_VERIFIED | With camShakeAmt=1 and dt=0.1, native cam-shake matches legacy decay exp(-1.4), applies deterministic camera offset, and clamps sub-threshold shake to 0 (test_legacy_bridge.mjs iter-789 phase). |
