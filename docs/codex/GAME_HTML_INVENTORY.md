...
_Generated by `tools/audit_migration.mjs --update` on 2026-05-24T04:31:35Z._

**Migration coverage:** 24/165 — 1 SEMANTIC_PROVEN + 9 BIND_ONLY + 14 native (13 DONE, 0 NATIVE_BUILT, 1 NATIVE_VERIFIED).
...
| `mountScopeFovTick` | yes | — | yes | yes | NATIVE_VERIFIED | Native scope-fov matches legacy aim spring, sprint FOV spring, sniper scope camDist save/restore, FOV 20/60+spring*8, and projection update side effect (test_legacy_bridge.mjs iter-795 phase). |
