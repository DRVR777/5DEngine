...
_Generated by `tools/audit_migration.mjs --update` on 2026-05-23T23:10:26Z._

**Coverage:** 21/165 (18 HOSTED via legacy-mount bridge + 3 DONE via native facets).
Remaining: 59 FACET-only / 85 DOC-only / 0 MISSING.
