...
_Generated by `tools/audit_migration.mjs --update` on 2026-05-24T04:27:14Z._

**Migration coverage:** 24/165 — 1 SEMANTIC_PROVEN + 10 BIND_ONLY + 13 native (12 DONE, 0 NATIVE_BUILT, 1 NATIVE_VERIFIED).
...
| `mountHeroFaceTick` | yes | yes | yes | yes | NATIVE_VERIFIED | With yaw=PI/2 and aiming held, native hero-face turns rotY/heading from 0 to PI/2 in one 0.1s tick, matching legacy dt*25 clamp; with KeyD movement and no aim, it turns toward right-vector heading with dt*10 clamp (test_legacy_bridge.mjs iter-793 phase). |
