...
_Generated by `tools/audit_migration.mjs --update` on 2026-05-23T22:46:42Z._

**Coverage:** 13/165 (10 HOSTED via legacy-mount bridge + 3 DONE via native facets).
Remaining: 61 FACET-only / 91 DOC-only / 0 MISSING.
