...
_Generated by `tools/audit_migration.mjs --update` on 2026-05-24T02:36:10Z._

**Coverage:** 23/165 — 1 SEMANTIC_PROVEN + 16 BIND_ONLY + 6 native (5 DONE, 0 NATIVE_BUILT, 1 NATIVE_VERIFIED).
...
| `mountSpeedBoostTick` | yes | — | yes | yes | NATIVE_VERIFIED | 3 decal-particles emitted via actions.spawnTrail $emit in 0.30s W+boost (test_legacy_bridge.mjs phase 4) |
