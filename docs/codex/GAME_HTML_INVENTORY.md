...
_Generated by `tools/audit_migration.mjs --update` on 2026-05-24T01:49:14Z._

**Coverage:** 23/165 — 3 SEMANTIC_PROVEN + 16 BIND_ONLY + 4 native (3 DONE, 0 NATIVE_BUILT, 1 NATIVE_VERIFIED).
...
| `mountHeroRegenTick` | yes | yes | yes | yes | NATIVE_VERIFIED | hp 60 -> 85 after 5x0.5s @ regen_rate 10/s (test_legacy_bridge.mjs phase 1) |
