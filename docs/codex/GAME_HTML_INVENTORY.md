...
_Generated by `tools/audit_migration.mjs --update` on 2026-05-24T04:34:24Z._

**Migration coverage:** 24/165 — 0 SEMANTIC_PROVEN + 9 BIND_ONLY + 15 native (14 DONE, 0 NATIVE_BUILT, 1 NATIVE_VERIFIED).
...
| `mountClockHudTick` | yes | yes | yes | yes | NATIVE_VERIFIED | With hour=13.5, native clock-hud writes 01:30 PM and day color #ffd166; with hour=null and fallback dayMix=0.8, native fallback writes a formatted AM/PM string (test_legacy_bridge.mjs iter-797 phase). |
